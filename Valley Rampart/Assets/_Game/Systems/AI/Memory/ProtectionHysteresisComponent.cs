...
// ============================================================================
//  3.0.1_2 输入输出决定层 - 保护因子滞回量化器组件
//  详见 3.0.1_2_输入输出决定层设计.md §9 / 决策8
//  HysteresisQuantizer 第二实例（保护 1 对阈值 [3]/[1] -> 二元 0-1）
// ============================================================================
...
public class ProtectionHysteresisComponent : IMemoryComponent
{
    ...
    public ProtectionHysteresisComponent(AttentionTuningConfig config)
    {
