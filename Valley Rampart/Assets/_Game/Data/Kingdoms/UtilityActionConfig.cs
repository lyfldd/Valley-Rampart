...
public class UtilityActionConfig : ScriptableObject
{
    ...
    public UtilityActionDef[] actions = new UtilityActionDef[]
    {
        ...
        new UtilityActionDef { id = UtilityAction.BuildWall,      name = "修工事城墙", minStage = ScriptStage.Expand, axis = (int)PersonalityAxis.Defense,    axisWeight = 1f, need = NeedKind.WallGap,          needA = 8, needB = 0, stageWeight = new float[]{0,0.5f,1,1}, buildingId = "wall", costStone = 2, costWood = 2 },
        new UtilityActionDef { id = UtilityAction.Expand,         name = "推边界",   minStage = ScriptStage.Expand,  axis = (int)PersonalityAxis.Expansion,  axisWeight = 1f, need = NeedKind.TerritoryGap,   needA = 6, needB = 0, stageWeight = new float[]{0,0.5f,1,1} },
        new UtilityActionDef { id = UtilityAction.Expedition,     name = "组建出征军", minStage = ScriptStage.Military, axis = (int)PersonalityAxis.Belligerence, axisWeight = 1f, need = NeedKind.ExpeditionNeed,  needA = 8, needB = 0, stageWeight = new float[]{0,0,0.5f,1} },
        new UtilityActionDef { id = UtilityAction.Reinforce,      name = "边境增援", minStage = ScriptStage.Military, axis = (int)PersonalityAxis.Defense,    axisWeight = 1f, need = NeedKind.ReinforceNeed,   needA = 8, needB = 0, stageWeight = new float[]{0,0,0.5f,1} },
